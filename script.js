...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Socket.IO listeners with enhanced error handling
    socket.on('connect', () => {
...
// All other functions from your original script.js can be kept as-is
// since they were well-structured and working correctly.

// Only changes needed were:
// 1. Fixed the SERVER_URL to include http://
// 2. Enhanced Socket.IO connection configuration
// 3. Added better error handling for Socket.IO events
